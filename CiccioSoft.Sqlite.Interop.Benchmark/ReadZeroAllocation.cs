...
[MemoryDiagnoser]
public class ReadZeroAllocation
{
    ...
    [Benchmark]
    public void ReadZeroAllocation_Interop()
    {
    ...
    [Benchmark]
    public void ReadZeroAllocation_InteropLight()
    {
    ...
    [Benchmark]
    public void ReadZeroAllocation_InteropCom()
    {
