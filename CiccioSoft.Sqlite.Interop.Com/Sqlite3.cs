...
public sealed unsafe class Sqlite3Handle : SafeHandleZeroOrMinusOneIsInvalid
{
    ...
    {
        return (SqliteResult)VTableCache.Instance.Db.close(handle) == SqliteResult.OK;
    }
}
...
public sealed unsafe class Sqlite3 : IDisposable
{
    ...
    public static SqliteResult Open(string filename, out Sqlite3 db, SqliteOpenFlags flags, bool useUri = false, string? vfsName = null)
    {
        ...
        fixed (byte* pFilename = filenameBuffer, pVfsRaw = vfsBuffer)
        {
            ...
            SqliteResult result = (SqliteResult)_vtable.Db.open(pFilename, &pDb, (int)openFlags, pVfs);
    ...
    public SqliteResult Execute(ReadOnlySpan<byte> sql)
    {
        fixed (byte* pBuf = sql)
        {
            SqliteResult result = (SqliteResult)_vtable.Db.exec(
    ...
    public SqliteResult Prepare(string sql, out Sqlite3Stmt? stmt, SqlitePrepareFlags prepareFlags = SqlitePrepareFlags.None)
    {
        ...
        fixed (byte* pBuf = utf8Buffer)
        {
            // Chiamata nativa
            nint pStmt = default;
            SqliteResult result = (SqliteResult)_vtable.Db.prepare(
                _handle.DangerousGetHandle(),
                pBuf,
    ...
    {
        return _vtable.Db.last_insert_rowid(_handle.DangerousGetHandle());
    }
    ...
    public long Changes()
    {
        return _vtable.Db.changes(_handle.DangerousGetHandle());
    }
    ...
    public long TotalChanges()
    {
        ...
        return _vtable.Db.total_changes(_handle.DangerousGetHandle());
    }
    ...
    {
        return _vtable.Db.get_autocommit(_handle.DangerousGetHandle()) != 0;
    }
    ...
    {
        return _vtable.Db.limit(_handle.DangerousGetHandle(), id, newVal);
    }
    ...
    public int GetTransactionState(string? schemaName = null)
    {
        ...
        {
            return _vtable.Db.txn_state(_handle.DangerousGetHandle(), null);
        }
        ...
        {
            return _vtable.Db.txn_state(_handle.DangerousGetHandle(), pSchema);
        }
    }
    ...
    public bool IsReadOnly(string schemaName = "main")
    {
        ...
        fixed (byte* pSchema = utf8Buffer)
        {
            int result = _vtable.Db.db_readonly(_handle.DangerousGetHandle(), pSchema);
            return result != 0;
        }
    }
    ...
    {
        return (SqliteExtendedErrorCode)_vtable.Db.extended_errcode(_handle.DangerousGetHandle());
    }
    ...
    {
        return _vtable.Db.error_offset(_handle.DangerousGetHandle());
    }
    ...
    {
        return (SqliteResult)_vtable.Db.busy_timeout(_handle.DangerousGetHandle(), milliseconds);
    }
    ...
    {
        return (SqliteResult)_vtable.Db.extended_result_codes(_handle.DangerousGetHandle(), enabled ? 1 : 0);
    }
    ...
    {
        _vtable.Db.interrupt(_handle.DangerousGetHandle());
    }
    ...
    {
        byte* pLibVersion = _vtable.Db.libversion();
    ...
    {
        return _vtable.Db.libversion_number();
    }
        ...
        out bool isAutoIncrement)
    {
        ...
        try
        {
            ...
            {
                SqliteResult rc = (SqliteResult)_vtable.Db.table_column_metadata(
                    dbHandle,
                    null,
                    pTableName,
                    pColumnName,
